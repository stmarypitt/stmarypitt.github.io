...
(function ($) {
	...
	getChannelIdForTabs = function (userId,tab_prefix,$youmaxContainer,isSelected) {
		//console.log('inside getChannelIdForTabs');
		//console.log('apiUrl-'+apiUrl);
		var youmax_global_options = $youmaxContainer.data('youmax_global_options');
		...
		$.ajax({
			...
			success: function(response) {
				//console.log(response);
				//console.log("tab_p	ix: "+tab_prefix);
	...
	displayChannelHeader = function(response,$youmaxContainer) {
		...
		var channelUserData = {
			...
			userimage:channelImage,
			userlink:'https://www.youtube.com/channel/'+channelId
		};
		$youmaxContainer.data('youmax_channel_user_data',channelUserData);
		...
		if(youmax_global_options.headerStyle=="open") {
	...
	processDescription = function(description) {
		...
		/*var uniqueSpotArray = [];
		$.each(spotArray, function(i, el){
		    if($.inArray(el, uniqueSpotArray) === -1) uniqueSpotArray.push(el);
		});
		spotArray = uniqueSpotArray;*/
	...
	insertUserSearchVideos = function(response,$youmaxContainer,createFlag,loadMoreFlag,paginateFlag,tabId) {
		...
		if(!loadMoreFlag) {
			...
			if($youmaxContainer.find('.youmax-tab-hover').length==0) {
				...
				channelUserData = $youmaxContainer.data('youmax_channel_user_data');
				$youmaxContainer.find('#youmax-showing-title').append('<div id="'+tabId+'" class="youmax-tab youmax-tab-hover youmax-showing-search-title" data-username="'+channelUserData.username+'" data-userimage="'+channelUserData.userimage+'" data-userlink="'+channelUserData.userlink+'"><i class="fa fa-search fa-1x youmax-showing-search-icon"></i>'+searchQuery+'</div>').show();
			}
			...
			if(null!=videoArray[i].snippet.thumbnails) {
				...
				if(isEvent) {
					...
					if(eventType=="upcoming" ) {
						//Custom thumbnails can be set via YouTube
			...
			if(itemType=="playlist") {
				if(youmax_global_options.playlistAction=="playall") {
					...
					$items.find('.youmax-main-thumbnail').click(function(){
						...
						displayItems(youmaxPlaylistId,$youmaxContainer,true);
	...
	displayItems = function(tabId,$youmaxContainer,showCustomTab) {
    ...
    $.fn.youmax = function(options) {
		...
		//added in 11.0
		youmax_global_options.tabStyle = options.tabStyle||"block"; //block or wire 

		youmax_global_options.tabBackgroundColor = options.tabBackgroundColor||"#f5f5f5"; 
		youmax_global_options.tabTextColor = options.tabTextColor||"#929090"; 
		youmax_global_options.tabHoverColor = options.tabHoverColor||"rgba(106, 106, 106, 0.09)"; 
		youmax_global_options.tabActiveBackgroundColor = options.tabActiveBackgroundColor||"#ACACAC"; 
		youmax_global_options.tabActiveTextColor = options.tabActiveTextColor||"white"; 

		youmax_global_options.youmaxBackgroundColor = options.youmaxBackgroundColor||"#e2e2e2"; 

		youmax_global_options.headerStyle = options.headerStyle||"block"; //block or open 

		youmax_global_options.loadmoreButtonBackgroundColor = options.loadmoreButtonBackgroundColor||"rgb(212, 212, 212)"; 
		youmax_global_options.loadmoreButtonTextColor = options.loadmoreButtonTextColor||"#666"; 
		youmax_global_options.loadmoreButtonHoverBackgroundColor = options.loadmoreButtonHoverBackgroundColor||"#383838"; 
		youmax_global_options.loadmoreButtonHoverTextColor = options.loadmoreButtonHoverTextColor||"white"; 

		youmax_global_options.gridItemBackgroundColor = options.gridItemBackgroundColor||"white"; 
		youmax_global_options.gridItemSeparatorColor = options.gridItemSeparatorColor||"#e2e2e2"; 
		youmax_global_options.gridItemTextColor = options.gridItemTextColor||"#666"; 
		youmax_global_options.gridItemTitleColor = options.gridItemTitleColor||"#5781d4"; 
		youmax_global_options.gridItemLinkColor = options.gridItemLinkColor||"#5781dc"; 
		youmax_global_options.gridItemIconColor = options.gridItemIconColor||"#b0b0af"; 

		youmax_global_options.gridItemSecondaryBackgroundColor = options.gridItemSecondaryBackgroundColor||"#f7f6f6"; 
		youmax_global_options.gridItemSecondaryTextColor = options.gridItemSecondaryTextColor||"#868686"; 
		youmax_global_options.gridItemSecondaryIconColor = options.gridItemSecondaryIconColor||"#b9b9b9"; 
		...
		if(youmax_global_options.skin.indexOf("clean")!=-1) {
			...
			youmax_global_options.headerStyle = "open";
		}		
		...
		custom_styles += '.youmax,#youmax-video-list-div{background-color:'+youmax_global_options.youmaxBackgroundColor+';}';
		

		//Tab Colors
		if(youmax_global_options.tabStyle=="block") {
		
			custom_styles += '#youmax-tabs{background-color:'+youmax_global_options.tabBackgroundColor+';}';
			custom_styles += '.youmax-tab{color:'+youmax_global_options.tabTextColor+';}';

			custom_styles += '.youmax-tab:hover{background-color:'+youmax_global_options.tabHoverColor+';}';

			custom_styles += '.youmax-tab.youmax-tab-hover{background-color:'+youmax_global_options.tabActiveBackgroundColor+';}';
			custom_styles += '.youmax-tab-hover{color:'+youmax_global_options.tabActiveTextColor+';}';
		
		
		} else {

			custom_styles += '#youmax-tabs{background-color:'+youmax_global_options.youmaxBackgroundColor+';}';
			custom_styles += '#youmax-tabs{border-bottom: 1px solid '+youmax_global_options.tabBackgroundColor+';}';
			custom_styles += '#youmax-tabs{display: inline-block;width: 100%;box-sizing: border-box;padding: 0px 25px;}';

			custom_styles += '.youmax-tab {float: left;margin: 0px;padding: 16px 14px;}';
			custom_styles += '.youmax-tab{color:'+youmax_global_options.tabTextColor+';}';

			custom_styles += '.youmax-tab:hover{color:'+youmax_global_options.tabHoverColor+';}';

			custom_styles += '.youmax-tab-hover{border-bottom: 1px solid '+youmax_global_options.tabActiveBackgroundColor+';}';
			custom_styles += '.youmax-tab.youmax-tab-hover{color:'+youmax_global_options.tabActiveTextColor+';}';

		}

		//Loading Button Colors
		custom_styles += '#youmax-next-div,#youmax-previous-div,#youmax-load-more-div{background-color:'+youmax_global_options.loadmoreButtonBackgroundColor+';}';
		custom_styles += '#youmax-next-div,#youmax-previous-div,#youmax-load-more-div{color:'+youmax_global_options.loadmoreButtonTextColor+';}';

		custom_styles += '#youmax-next-div:hover,#youmax-previous-div:hover,#youmax-load-more-div:hover,#youmax-load-more-div.youmax-load-more-div-click,#youmax-next-div.youmax-load-more-div-click,#youmax-previous-div.youmax-load-more-div-click{background-color:'+youmax_global_options.loadmoreButtonHoverBackgroundColor+';}';
		custom_styles += '#youmax-next-div:hover,#youmax-previous-div:hover,#youmax-load-more-div:hover,#youmax-load-more-div.youmax-load-more-div-click,#youmax-next-div.youmax-load-more-div-click,#youmax-previous-div.youmax-load-more-div-click{color:'+youmax_global_options.loadmoreButtonHoverTextColor+';}';


		//Grid Item Colors
		custom_styles += "#tiles li p{background-color:"+youmax_global_options.gridItemBackgroundColor+";}";
		custom_styles += "span.youmax-view-date-holder{border-top:1px solid "+youmax_global_options.gridItemSeparatorColor+";}";
		if(youmax_global_options.skin=="trend2") {
			custom_styles += "span.youmax-trend-link-holder {border-top: 1px solid "+youmax_global_options.gridItemSeparatorColor+";}";
		}
		if(youmax_global_options.skin=="block3") {
			custom_styles += ".youmax-like-comment-holder {border-top: 1px solid "+youmax_global_options.gridItemSeparatorColor+";}";
		}
		custom_styles += ".youmax-video-list-title{color:"+youmax_global_options.gridItemTitleColor+";}";
		custom_styles += ".youmax-title-desc-holder a{color:"+youmax_global_options.gridItemLinkColor+";}";
		custom_styles += ".youmax-video-list-description{color:"+youmax_global_options.gridItemTextColor+";}";
		custom_styles += ".youmax-view-date-holder{color:"+youmax_global_options.gridItemTextColor+";}";
		custom_styles += ".youmax-view-date-holder i{color:"+youmax_global_options.gridItemIconColor+";}";
		

		//Secondary colors

		//trend link
		custom_styles += ".youmax-thumbnail-link{color:"+youmax_global_options.gridItemSecondaryIconColor+"}";
		custom_styles += ".youmax-link{border-color:"+youmax_global_options.gridItemSecondaryTextColor+"}";
		//block likes & comments
		custom_styles += ".youmax-like-comment-holder i{color:"+youmax_global_options.gridItemSecondaryIconColor+"}";
		custom_styles += ".youmax-like-comment-holder {color:"+youmax_global_options.gridItemSecondaryTextColor+"}";
		custom_styles += ".youmax-like-comment-holder {background-color:"+youmax_global_options.gridItemSecondaryBackgroundColor+"}";


		$("body").append("<style class='youmax-added-styles'>"+custom_styles+"</style>");
